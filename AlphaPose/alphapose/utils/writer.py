...
from alphapose.utils.transforms import get_func_heatmap_to_coord #alphapose.utils.
from alphapose.utils.pPose_nms import pose_nms, write_json

DEFAULT_VIDEO_SAVE_OPT = {
    'savepath': '../ProcessJSON/res/1.mp4',
...
class DataWriter():
    ...
    def update(self):
        ...
        while True:
            ...
            if im_name and boxes is None:
                result = {'imgname': im_name,
                          'category_id': None,
                          'keypoints': None,
                          'score': None,
                          'box': None,
...
#
                ...
                if orig_img is None:
                    ...
                    if self.save_video:
                        stream.release()
                    write_json(final_result, self.opt["outputpath"], form=self.opt["format"], for_eval=self.opt["eval"], outputfile=(self.opt["det_dir"] + '_results.json'))
