...
def parse_config(argv=None):
    ...
    description = 'PyTorch implementation of DMMR'
    ...
    parser.add_argument('--single_view',
                        default=False,
                        type=lambda x: x.lower() in ['true', '1'],
                        help='Init model using result of last frame')   
    ...
    parser.add_argument('--num_people',
                        default=1,
                        type=int,
                        help='The number of people in the optimization')   
    # output related
    ...
    parser.add_argument('--model_type', default='smpl', type=str,
                        choices=['smpl', 'smplh', 'smplx', 'smpllsp', 'smplhalpe'],
    ...
    parser.add_argument('--use_motionprior', default=False,
                        type=lambda arg: arg.lower() in ['true', '1'],
                        help='Use the VAE motion embedding')
    ...
    parser.add_argument('--kinetic_weights',
                        default=[1e2, 5 * 1e1, 1e1, .5 * 1e1],
                        type=float, nargs='*',
                        help='The weights of the Shape regularizer')
    ...
    parser.add_argument('--scale_child',
                        default=[.4545], type=float,
                        nargs='*',
                        help='The child scale parameter')
    ...
    parser.add_argument('--fix_shape',
                        ...
                        default=False,
                        help='Use 3D annotation for the computations')
    parser.add_argument('--opt_cam',
                        default=False,
                        type=lambda x: x.lower() in ['true', '1'],
                        help='optimize camera extris')
