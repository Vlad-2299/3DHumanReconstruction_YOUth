...
class Visualization(object):
    def __init__(self) -> None:
        ...
        self.viewer = o3d.visualization.VisualizerWithKeyCallback() #O3DVisualizer Visualizer
        window_size = 1200
        self.viewer.create_window(
            visible=True,
            width=960, 
            height=620,
            window_name='3DHumanReconstruction_YOUth'
        )
        self.count = 0
        self.frame_n = 0
    ...
    def get_frame_n(self):
        return self.frame_n

    def set_frame_n(self, frame_n):
    ...
    def visualize_meshes(self, pathes):
        colors = [[0.01, 0.6, 0.01], [0.6, 0.01, 0.01]]
