...
def plot_allviews_histogram(comul_value, y_label, max_y):
    ...
    axes[0, 0].set_title(f'View 0 - Avg: {round(sum(v1)/len(v1), 3)}')
    ...
    axes[0, 1].set_title(f'View 1 - Avg: {round(sum(v2)/len(v2), 3)}')
    ...
    axes[1, 0].set_title(f'View 2 - Avg: {round(sum(v3)/len(v3), 3)}')
    ...
    axes[1, 1].set_title(f'View 3 - Avg: {round(sum(v4)/len(v4), 3)}')
